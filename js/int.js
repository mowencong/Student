$(function() {
	...
	setInterval('AutoScrollB("http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.gouMain .itemA .list")',4000);
	setInterval('AutoScrollB("http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemB .hot")',3000);
	...
	$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.yuMain .itemC .cate li a.a1').click(function(){
	...
	$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.yuMain .itemC .cate li a.a2').click(function(){
	...
	$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.yuMain .itemC .cate li a.a3').click(function(){
	...
	$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.yuMain .itemC .cate li a.a4').click(function(){
	...
	$('.indexLeft .re h3').click(function(){
		if($(this).parent().find('div').is(":visible")==false){
			$("http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .re .item").each(function(i){ 
	...
	$('.indexLeft .itemC .s1 strong').click(function(){
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s1').animate({left: '0px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s2').animate({left: '467px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s3').animate({left: '532px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s4').animate({left: '597px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s5').animate({left: '662px'}, 300);
	});
	$('.indexLeft .itemC .s2 strong').click(function(){
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s1').animate({left: '0px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s2').animate({left: '65px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s3').animate({left: '532px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s4').animate({left: '597px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s5').animate({left: '662px'}, 300);
	});
	$('.indexLeft .itemC .s3 strong').click(function(){
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s1').animate({left: '0px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s2').animate({left: '65px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s3').animate({left: '130px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s4').animate({left: '597px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s5').animate({left: '662px'}, 300);
	});
	$('.indexLeft .itemC .s4 strong').click(function(){
		...
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s2').animate({left: '65px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s3').animate({left: '130px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s4').animate({left: '195px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s5').animate({left: '662px'}, 300);
	});
	$('.indexLeft .itemC .s5 strong').click(function(){
		...
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s3').animate({left: '130px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s4').animate({left: '195px'}, 300);
		$('http://demo.cssmoban.com/cssthemes2/ftpm_45/js/.indexLeft .itemC .s5').animate({left: '260px'}, 300);
	});
})
